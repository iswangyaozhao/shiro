 ...
 * Generated at: 2018-03-12 01:55:30 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\tRoleName : <input type=\"text\" name=\"\" id=\"name\" />\n");
      out.write("\t<!--  roles : <div style=\"min-width:100px; display: inline-block;\">\n");
      out.write("  \t\t<input id=\"roles\" class=\"easyui-tagbox\" name=\"roleIds\" style=\"width: auto;min-width: 100px;\"  data-options=\"hasDownArrow:true,valueField:'id',textField:'name',url:'role/all',panelHeight:'auto',panelMaxHeight:250,multiple:true,editable:false,panelMinWidth:150\">\n");
      out.write("    \t\t</div>-->\n");
      ...
      out.write("</div>\n");
      out.write("<table id=\"roleTable\"  title=\"role List\"\n");
      ...
      out.write("            <th data-options=\"field:'name',width:100,sortable:true\">RoleName</th>\n");
      out.write("            <th data-options=\"field:'available',width:120\">available</th>\n");
      out.write("            <th data-options=\"field:'hi',width:50,formatter:opFormatter\">操作</th>\n");
      out.write("        </tr>\n");
      out.write("    </thead>\n");
      out.write("</table>\n");
      out.write("<div id=\"tb\">\n");
      out.write("<a href=\"user/index\" class=\"easyui-linkbutton\"  data-options=\"iconCls:'icon-back',plain:true\">用户管理</a>\n");
      out.write("<a href=\"permission/index\" class=\"easyui-linkbutton\"  data-options=\"iconCls:'icon-back',plain:true\">权限管理</a>\n");
      ...
      out.write("\t\t\t\t\tposition: 'right'//出现在右侧\n");
      out.write("\t\t\t\t});\n");
      out.write("\t\t\t}\n");
      out.write("\t\t});\n");
      out.write("\t})\n");
      ...
      out.write("\t\t$(\"#roleTable\").datagrid(\"clearSelections\");//清除选中行\n");
      out.write("\t\tvar d = $(\"<div></div>\").appendTo(\"body\");\n");
      out.write("\t\td.dialog({\n");
      out.write("\t\t\ttitle : \"分配权限\",\n");
      out.write("\t\t\twidth:250,\n");
      out.write("\t\t\theight:350,\n");
      out.write("\t\t\thref : \"role/toAssign?rid=\"+roleId,//根据rid获取他所拥有的权限\n");
      ...
      out.write("\t\t\t\t\t\t$.messager.show({//右下角出来的提示框\n");
      out.write("\t\t\t\t\t\t\ttitle:'提示',\n");
      ...
      out.write("\t\tvar postData = {name : $(\"#name\").val()};\n");
      ...
      out.write("\t\t\treturn;\n");
      out.write("\t\t}\n");
      out.write("\t\t$.messager.confirm(\"提示\",\"确定要删除选中的数据吗？\",function(d){\n");
      out.write("\t\t\tif(d){\n");
      out.write("\t\t\t\tvar postData = \"\";\n");
      ...
      out.write("\t\t\tmodal:true,//是否是模态框\n");
      out.write("\t\t\thref : \"role/form\",\n");
      out.write("\t\t\tonClose:function(){$(this).dialog(\"destroy\"); },//destroy销毁\n");
      out.write("\t\t\tbuttons:[{\n");
      out.write("\t\t\t\ticonCls:\"icon-ok\",\n");
      out.write("\t\t\t\ttext:\"确定\",\n");
      out.write("\t\t\t\thandler:function(){//点击确定按钮的操作\n");
